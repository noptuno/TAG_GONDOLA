...
public class ParserXmlElo {
    ...
    private static final String ETIQUETA_16_Txt_Oferta = "Precio_lista";
    public ParserXmlElo(Context context){
    ...
    public Producto parsear(InputStream in) throws XmlPullParserException, IOException {
    ...
    private Producto leerEnvelope(XmlPullParser parser)throws XmlPullParserException, IOException {
...
return prod;
    ...
    private Producto RegistrarProducto(XmlPullParser parser) throws XmlPullParserException, IOException {
        ...
        while (parser.next() != XmlPullParser.END_TAG) {
            ...
            switch (namee) {
                ...
                case ETIQUETA_16_Txt_Oferta:
                    Precio_lista=leerPrecio_Lista(parser);
                    break;
    ...
    private String leerPrecio_Lista(XmlPullParser parser) throws IOException, XmlPullParserException {
        parser.require(XmlPullParser.START_TAG, ns, ETIQUETA_16_Txt_Oferta);
        String nombre = obtenerTexto(parser);
        parser.require(XmlPullParser.END_TAG, ns, ETIQUETA_16_Txt_Oferta);
        return nombre;
    }
